...
STRINGS = {
    "de": {
        ...
        "guide_file": "https://github.com/schn4ppi/SyncManga#readme",
        ...
        "xg_al": '🔄 <b>AniList-Auto-Sync:</b> kostenloses Konto auf <a href="https://anilist.co/signup" target=_blank rel=noopener>anilist.co/signup</a> anlegen (falls noch keins), dann einmalig <code>python -m tools.anilist_auth</code> ausführen (Browser öffnet → Approve → Code ins Fenster kopieren) — danach schreibt jeder Lauf deinen Fortschritt von selbst zu AniList.',
        "xg_more": '📖 <b><a href="https://github.com/schn4ppi/SyncManga#readme" target=_blank rel=noopener>Ausführliche Anleitung öffnen</a></b> — alle Funktionen Schritt für Schritt (auf GitHub).',
    ...
    "en": {
        ...
        "xg_al": '🔄 <b>AniList auto-sync:</b> create a free account at <a href="https://anilist.co/signup" target=_blank rel=noopener>anilist.co/signup</a> (if you have none), then run <code>python -m tools.anilist_auth</code> once (browser opens → Approve → paste the code) — after that every run pushes your progress to AniList automatically.',
        "xg_more": '📖 <b><a href="https://github.com/schn4ppi/SyncManga#readme" target=_blank rel=noopener>Open the full guide</a></b> — every feature, step by step (on GitHub).',
