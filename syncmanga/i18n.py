...
STRINGS = {
    "de": {
        ...
        # Empfehlungen als Karten (Werkzeugfenster, JB 25.09.2026)
        "recs_head": "Nach deinen Genres", "recs_chip_hint": "Klick: Genre an · zweimal: bevorzugt",
        "recs_ch1": "📖 Kapitel 1",
        "recs_hint": "Weil deine Liste viel {g} enthält — diese Serien (extern, noch nicht in deiner Liste) könnten dir gefallen:",
        "recs_anker_titel": "Leser deiner Reihen empfehlen (MangaUpdates):",
        "recs_anker_grund": "Leser von {w}",
        ...
        "gear_title": "Weitere Werkzeuge (Tag/Nacht, Kacheln, Kompakt, Speichern, Im-/Export)",
        ...
        "xg_al": '🔄 <b>AniList-Auto-Sync:</b> kostenloses Konto auf <a href="https://anilist.co/signup" target=_blank rel=noopener>anilist.co/signup</a> anlegen (falls noch keins), dann einmalig <code>anilist_verbinden.bat</code> (im SyncManga-Ordner) doppelklicken (Browser öffnet → Approve → Code ins schwarze Fenster) — danach schreibt jeder Lauf deinen Fortschritt von selbst zu AniList.',
        ...
        "xg_bug": '🐛 <b><a href="https://mail.google.com/mail/?view=cm&fs=1&to=jan.bernd.kalvelage@gmail.com&su=%5BSyncManga%5D%20Fehlerbericht&body=Was%20ist%20passiert%3F%0A%0AWelche%20Serie%2FSeite%3F%0A%0A(Gern%20die%20broken_links.json%20vom%20%E2%9A%A0-Knopf%20anh%C3%A4ngen.)" target=_blank rel=noopener>Fehler melden</a></b> — kurze Mail genügt; Berichte fließen direkt in die Fehlerbehebung.',
        ...
        # Statistik im Werkzeugfenster (JB 25.09.2026): beschriftete Kacheln, Balken, Listen
        "num_grp": ".", "num_dec": ",",
        "st_rating": "Ø Bewertung", "st_cover": "mit Reserve-Link", "st_progress": "Lese-Fortschritt",
        "st_country": "Herkunft", "st_type": "Typ", "st_top": "Bestbewertet", "st_adult": "18+",
        "st_mono": "ohne Reserve-Link: {n}",
        "pg_reading": "lese gerade", "pg_caught": "aufgeholt", "pg_finished": "abgeschlossen",
        "pg_paused": "pausiert", "pg_backlog": "Backlog",
        "legend_ok": "funktioniert", "legend_browser": "nur im Browser", "legend_maint": "in Wartung", "legend_down": "nicht erreichbar",
        # 🚦 Quellen mit Pausen je Zeile (Werkzeugfenster, JB 25.09.2026)
        "legend_none": "ungeprüft", "legend_degraded": "eingeschränkt",
        "q_title": "Quellen", "q_sub": "Ampel und Pause je Seite", "q_series_n": "{n} Serien",
        "q_search": "Seite suchen", "q_switch_note": "Schalter an = pausiert",
        "q_pause_aria": "{name} pausieren", "q_paused_n": "· {n} pausiert",
        ...
        "ov_menu": "📊 Übersicht", "ov_menu_title": "Statistik und Empfehlungen", "ov_title": "Übersicht",
        "cols_menu": "⚙ Spalten",
        "cols_menu_title": "Spalten ein-/ausblenden",
        # Werkzeugfenster (JB 25.09.2026): Spalten mit ausgeschriebenen Namen + Standard
        "cols_head": "Spalten einblenden",
        "cols_note": "Serie, Favorit, gelesen und Aktion bleiben immer sichtbar.",
        "cols_reset": "Standard wiederherstellen",
        "col_trans_long": "übersetzt (ü.)", "col_last_long": "Zuletzt gelesen",
        "col_author_long": "Autor unter dem Titel",
        ...
        "pause_group": "{n} Seiten mit je einer Serie",
        ...
        "tray_cloud_newcode": "   Neuen Zugangscode erzeugen",
        ...
        "cloud_newcode_ok": "Neuer Zugangscode: {code} — der alte gilt nicht mehr.",
        ...
        "upd_need_setup": "Update auf v{v} gibt es nur noch als Installer — bitte einmal SyncManga-Setup.exe von GitHub ausführen.",
    ...
    "en": {
        ...
        "recs_head": "Based on your genres", "recs_chip_hint": "Click: genre on · twice: preferred",
        "recs_ch1": "📖 Chapter 1",
        "recs_hint": "Because your list is full of {g} — these series (external, not in your list yet) might be for you:",
        "recs_anker_titel": "Readers of your series recommend (MangaUpdates):",
        "recs_anker_grund": "Readers of {w}",
        ...
        "gear_title": "More tools (day/night, tiles, compact, save, import/export)",
        ...
        "xg_al": '🔄 <b>AniList auto-sync:</b> create a free account at <a href="https://anilist.co/signup" target=_blank rel=noopener>anilist.co/signup</a> (if you have none), then double-click <code>anilist_verbinden.bat</code> (in the SyncManga folder) once (browser opens → Approve → paste the code) — after that every run pushes your progress to AniList automatically.',
        "xg_more": '📖 <b><a href="Guide.html" target=_blank>Open the full guide</a></b> — every feature, step-by-step setup (AniList, Gmail, Web.de).',
        "xg_bug": '🐛 <b><a href="https://mail.google.com/mail/?view=cm&fs=1&to=jan.bernd.kalvelage@gmail.com&su=%5BSyncManga%5D%20Bug%20report&body=What%20happened%3F%0A%0AWhich%20series%2Fsite%3F%0A%0A(Feel%20free%20to%20attach%20broken_links.json%20from%20the%20%E2%9A%A0%20button.)" target=_blank rel=noopener>Report a bug</a></b> — a short mail is enough; reports feed straight into fixes.',
        ...
        "num_grp": ",", "num_dec": ".",
        "st_rating": "Avg. rating", "st_cover": "with backup link", "st_progress": "Reading progress",
        "st_country": "Origin", "st_type": "Type", "st_top": "Top rated", "st_adult": "18+",
        "st_mono": "without backup link: {n}",
        "pg_reading": "reading", "pg_caught": "caught up", "pg_finished": "finished",
        "pg_paused": "paused", "pg_backlog": "backlog",
        "legend_ok": "working", "legend_browser": "browser only", "legend_maint": "maintenance", "legend_down": "down",
        "legend_none": "unchecked", "legend_degraded": "degraded",
        "q_title": "Sources", "q_sub": "Status and pause per site", "q_series_n": "{n} series",
        "q_search": "Find site", "q_switch_note": "switch on = paused",
        "q_pause_aria": "Pause {name}", "q_paused_n": "· {n} paused",
        ...
        "ov_menu": "📊 Overview", "ov_menu_title": "Statistics and recommendations", "ov_title": "Overview",
        "cols_menu": "⚙ Columns",
        "cols_menu_title": "Show/hide columns",
        "cols_head": "Show columns",
        "cols_note": "Series, favourite, read and action always stay visible.",
        "cols_reset": "Restore defaults",
        "col_trans_long": "translated (t.)", "col_last_long": "Last read",
        "col_author_long": "Author below the title",
        ...
        "pause_group": "{n} sites with one series each",
        ...
        "tray_cloud_newcode": "   Generate a new access code",
        ...
        "cloud_newcode_ok": "New access code: {code} — the old one no longer works.",
        ...
        "upd_need_setup": "Update v{v} is only available as an installer — please run SyncManga-Setup.exe from GitHub once.",
