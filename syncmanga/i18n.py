...
STRINGS = {
    "de": {
        ...
        "xg_al": '🔄 <b>AniList-Auto-Sync:</b> kostenloses Konto auf <a href="https://anilist.co/signup" target=_blank rel=noopener>anilist.co/signup</a> anlegen (falls noch keins), dann einmalig <code>python -m tools.anilist_auth</code> doppelklicken (Browser öffnet → Approve → Code ins schwarze Fenster) — danach schreibt jeder Lauf deinen Fortschritt von selbst zu AniList.',
    ...
    "en": {
        ...
        "xg_al": '🔄 <b>AniList auto-sync:</b> create a free account at <a href="https://anilist.co/signup" target=_blank rel=noopener>anilist.co/signup</a> (if you have none), then double-click <code>python -m tools.anilist_auth</code> once (browser opens → Approve → paste the code) — after that every run pushes your progress to AniList automatically.',
