...
>
> **Stand:** 2026-08-08 · **Fassung:** 1.18 · **Pflege:** JB + Claude
...
| Datei | Wofür |
|---|---|
| **`../CLAUDE.md`** | ⬅ **zuerst lesen** — wie hier gearbeitet wird: JBs Vorgaben wörtlich, vier Leitplanken, vier Faustregeln |
| `ENTWUERFE.md` | welche Entwürfe es gibt und was noch fehlt |
| **`LEHRBUCH.md`** | zehn Bau-Lehren mit Vorfall und Grund — **projektübergreifend gültig**, deshalb getrennt vom Bauplan |
...
| Datum | Was |
|---|---|
| 2026-08-08 | Fassung 1.18 — **Wissen destilliert: zwei neue Speicher, keine Entscheidung geändert.** Auf JBs Anweisung wurde die Sitzung in dauerhaftes Wissen überführt — **durch Kuratieren, nicht durch Anfügen**. Am Bauplan selbst ändert sich **nichts**: die 183 Entscheidungen, §15 und alle Entwürfe bleiben, wie sie sind. Neu sind zwei Ebenen, die es bisher nicht gab und die nicht ins Pflichtenheft gehören: **`CLAUDE.md` im Wurzelverzeichnis** — wie hier gearbeitet wird: JBs sieben Vorgaben **wörtlich mit Datum** (von *„Recherche Recherche Recherche"* bis *„ich will reparieren, keine neuen Säulen ziehen"*), **vier Leitplanken** (keine Piraterie-Adressliste · nichts Vertrauliches in Repo-Dateien · die laufenden Vorgänger werden gelesen, nicht verändert · kein ungeprüftes Artefakt) und **vier Faustregeln** zum Umgang miteinander (Alternativen ohne Vogelscheuchen · bei Widerspruch erst nachrechnen · jede Frage eines Absatzes beantworten · *„entscheide du"* heißt begründet entscheiden). **`Doku/LEHRBUCH.md`** — zehn Bau-Lehren, jede mit **Vorfall, Regel, Grund und Geltungsbereich**, ausdrücklich **projektübergreifend**: L1 ein reparierter Fehler hat oft einen unreparierten Zwilling · **L2 wenn du eine Konfliktregel brauchst, ist meistens das Modell zu grob** (aus der zurückgenommenen Fortschrittsregel) · L3 bei einer Übernahme zweimal suchen, nach Architektur **und** nach Funktionen (aus den 878 übersehenen Zeilen) · L4 Wiederlesen findet die eigenen Fehler nicht · L5 eine geerbte Faustregel gilt erst, wenn sie auf die konkrete Anlage gerechnet wurde (aus 3-2-1 gegen ein einzelnes NAS) · L6 eine Übergabe ist erst vollständig, wenn der Empfänger jeden Verweis öffnen kann · L7 bei asymmetrischem Risiko entscheidet die Schadenshöhe · L8 Höhen werden gemessen, nie geraten · L9 zeig Alternativen, die du ernst meinst · **L10 sag nie „vollständig", ohne eine Suche, die das Gegenteil beweisen könnte**. **Geschärft statt dupliziert:** die Begleitdatei-Tabelle in §0 nennt jetzt beide neuen Speicher mit ihrer Abgrenzung; `PFLEGE.md` Prüfung 9 verweist für das *Warum* auf L4 und behält nur das *Wie*; der Übergabe-Prompt liest `CLAUDE.md` als Punkt 0 und das Lehrbuch als 6b. **Bewusst nicht ins Repo gewandert:** die Handelsregister- und Zertifikatsdaten aus dieser Sitzung (Leitplanke L2). |
| 2026-08-08 | Fassung 1.17 — **Strukturprüfung: drei neue Lücken, alle von anderer Art.** JB fragte *„Was fehlt jetzt noch? Steht das Grundgerüst und die Oberfläche?"* — und statt es zu behaupten, wurde nachgesucht. Die zehn Lücken vom 07.08. sind geschlossen; **drei neue kamen aus drei mechanischen Suchen**, keine davon durch Wiederlesen. ⚠️ **Die Werkstatt** wird im Heft **neunmal namentlich genannt** — als der Ort, an dem Regeln landen (E141), Handkorrekturen leben (E135), Heilungsvorschläge angeboten werden (E173) und Vorschläge zurückgenommen werden (E41) — und ist **nie definiert und nie gezeichnet**: vier tragende Entscheidungen zeigen auf einen leeren Raum. **Die Einstellungen** haben zwölf verstreute Erwähnungen und keinen Ort, obwohl inzwischen zwölf Sorten Einstellung existieren — ohne Entwurf wird das die Abladefläche, vor der E39 warnt. **Leere und kaputte Zustände** kommen nahezu **null**-mal vor, obwohl jeder Bildschirm einen hat; sie entscheiden, ob sich ein Programm kaputt oder ruhig anfühlt. Dazu **Werke von Hand teilen und zusammenführen** — das Postfach kennt *doppelt* (E141, Grund 4), aber *„das sind eigentlich zwei Werke"* hat keinen Weg, und bei 800 Werken passiert das sicher. **Neu in `PFLEGE.md`: die drei Suchen** als Prüfung 9 — *oft genannt, nie erklärt* · *kommt gar nicht vor* · *Handlung ohne Weg*. Sie fanden alle drei Lücken auf einmal und laufen künftig monatlich; **das Wiederlesen eines Dokuments findet die Fehler nicht, die man beim Schreiben gemacht hat.** **Aufgeräumt:** die Abschnittsnummern in §5 standen durcheinander (5.9.1 nach 5.10, 5.10.2 nach 5.11) — jetzt in Reihenfolge. **Die Antwort auf die Frage selbst:** das **Grundgerüst steht** und hat fünf unabhängige Belastungsproben ohne eine gebogene Regel überstanden (Musik E96 · Film · Spiele E159 · ferne Orte E169 · Fortschritt E182); die **Oberfläche steht bis auf die drei Bildschirme oben**, die jedes Programm hat und die niemand entwirft. |
